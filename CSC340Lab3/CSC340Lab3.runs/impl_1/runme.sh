...
HD_PWD='/home/cr1tterp0wer/CSC340Lab3/CSC340Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mystery.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mystery.tcl -notrace

...
HD_PWD='/home/cr1tterp0wer/CSC340Lab3/CSC340Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mystery.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mystery.tcl
